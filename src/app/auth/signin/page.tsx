...
export default function AdminLoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#050505] p-4 relative overflow-hidden font-sans">
            ...
            <div className="w-full max-w-[440px] relative z-10 transition-all duration-500 ease-out">
                {/* Branding Section */}
                <div className="text-center mb-10 transition-all duration-700 animate-in fade-in slide-in-from-top-8">
                    <div className="relative inline-block group">
                        ...
                        <div className="relative inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-emerald-500 to-emerald-700 rounded-3xl shadow-2xl mb-6 shadow-emerald-500/20 rotate-3 group-hover:rotate-0 transition-all duration-500">
                            <ShieldCheck className="w-10 h-10 text-white" />
                        </div>
                    </div>
                    <h1 className="text-4xl font-black tracking-tighter text-white mb-2 leading-none">
                        BongaChapaa <span className="text-emerald-500">Admin</span>
                    </h1>
                ...
                <div className="bg-zinc-900/40 backdrop-blur-3xl rounded-[40px] p-10 shadow-[0_0_80px_rgba(0,0,0,0.5)] border border-white/5 relative overflow-hidden group animate-in zoom-in-95 duration-700">
                    ...
                    <form onSubmit={handleLogin} className="space-y-8">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative group/input">
                                ...
                                <input
                                    ...
                                    className="w-full pl-14 pr-4 py-4 bg-white/5 border border-white/5 rounded-2xl focus:ring-1 focus:ring-emerald-500/50 focus:border-emerald-500/50 focus:bg-white/[0.08] transition-all outline-none text-white font-medium placeholder:text-zinc-600 shadow-inner"
                                />
                            </div>
                        </div>
                        <div className="space-y-3">
                            ...
                            <div className="relative group/input">
                                ...
                                <input
                                    ...
                                    placeholder="••••••••"
                                    className="w-full pl-14 pr-14 py-4 bg-white/5 border border-white/5 rounded-2xl focus:ring-1 focus:ring-emerald-500/50 focus:border-emerald-500/50 focus:bg-white/[0.08] transition-all outline-none text-white font-medium placeholder:text-zinc-600 shadow-inner"
                                />
                                <button
                                    type="button"
                        ...
                        >
                            <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-emerald-400/20 to-transparent -translate-x-full group-hover/btn:translate-x-full transition-transform duration-1000"></div>
                            {isLoading ? (
